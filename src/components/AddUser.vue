...
/**
 * Submits the add user form.
 *
 * Calls `mockApi.createUser` with the form values, shows a success toast if it succeeds,
 * and emits a "reload" event to tell the parent component to reload its data.
 *
...
const submitForm = async () => {
  try {
    ...
    await mockApi.createUser(user.value as any);
